-- Seed three launch posts for the Tyoutor Pro blog.
-- Rich, SEO-optimised content so the listing page isn't empty and pages can rank.

insert into public.blog_posts
  (slug, title, excerpt, content, cover_image_url, category, tags, author_name, read_time_minutes, published, published_at)
values
(
  'vietnamese-esl-common-mistakes',
  '10 Common Mistakes Vietnamese ESL Learners Make (And How to Fix Them)',
  'A practical guide to the pronunciation, grammar, and vocabulary errors you''ll hear most often from Vietnamese students — with classroom-tested fixes you can use tomorrow.',
  $HTML$
...
(
  ...
  'The weekly planning system that saves experienced ESL teachers 10+ hours a month. Includes a free template and a step-by-step walkthrough.',
  $HTML$
...
(
  ...
  'Everything you need to walk into a TEFL interview with confidence — from the 20-minute lesson structure hiring managers look for to the methodology language that gets you the job.',
  $HTML$
