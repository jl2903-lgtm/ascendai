...
export default function PricingPage() {
  return (
    <div className="min-h-screen bg-[#0F172A] text-[#F8FAFC]">
      {/* Nav */}
      <nav className="border-b border-[#334155]/50 px-6 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link href="/auth/login" className="text-sm text-[#94A3B8] hover:text-white transition-colors px-4 py-2">Log in</Link>
      ...
      <div className="max-w-5xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
          ...
          <div className="bg-[#1E293B] border border-[#334155] rounded-2xl p-8">
            <div className="mb-8">
              <div className="text-sm font-semibold text-[#94A3B8] uppercase tracking-wider mb-3">Free</div>
              <div className="flex items-baseline gap-1 mb-1">
                <span className="text-5xl font-extrabold">$0</span>
              </div>
              <p className="text-[#94A3B8] text-sm">Forever free · No credit card</p>
            </div>

            <ul className="space-y-3 mb-8">
              {FREE_FEATURES.map(f => (
                <li key={f.text} className={`flex items-center gap-3 text-sm ${f.included ? 'text-[#CBD5E1]' : 'text-[#475569]'}`}>
                  {f.included ? (
                    <CheckCircle className="w-4 h-4 text-teal-500 flex-shrink-0" />
                  ) : (
                    <X className="w-4 h-4 text-[#334155] flex-shrink-0" />
                  )}
            ...
            <Link href="/auth/signup" className="block w-full text-center border border-[#334155] hover:border-teal-500 text-[#94A3B8] hover:text-white font-semibold px-6 py-3.5 rounded-xl transition-colors">
              Get Started Free
            </Link>
          </div>

          {/* Pro */}
          <div className="relative bg-gradient-to-b from-teal-900/40 via-[#1E293B] to-[#1E293B] border border-teal-600/60 rounded-2xl p-8 shadow-xl shadow-teal-900/20">
            ...
            <div className="mb-8">
              ...
              <p className="text-[#94A3B8] text-sm">Cancel anytime · No hidden fees</p>
            </div>

            <ul className="space-y-3 mb-8">
              {PRO_FEATURES.map(f => (
                <li key={f.text} className="flex items-center gap-3 text-sm text-[#CBD5E1]">
            ...
            <p className="text-xs text-center text-[#475569] mt-3">No charge until trial ends</p>
          </div>
        </div>
        ...
        <div className="mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={group.title} className="bg-[#1E293B] border border-[#334155] rounded-2xl p-6">
        ...
        <div className="mt-20 max-w-2xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={faq.q} className="bg-[#1E293B] border border-[#334155] rounded-2xl p-5">
                <h3 className="font-semibold text-[#F8FAFC] mb-2 text-sm">{faq.q}</h3>
        ...
        <div className="text-center mt-20">
          ...
          <p className="text-[#94A3B8] mb-6">Try the free plan. No credit card. No pressure.</p>
