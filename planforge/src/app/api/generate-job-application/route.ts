...
export async function POST(req: NextRequest) {
  try {
    ...
    const { type, schoolType, country, experienceLevel, certifications, motivation, schoolValues } = await req.json()
...
${!isCoverLetter && schoolValues ? `- School values: ${schoolValues}` : ''}
