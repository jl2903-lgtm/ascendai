...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#0F172A] text-[#F8FAFC]">
      {/* Navbar */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0F172A]/80 backdrop-blur-md border-b border-[#334155]/50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link href="/auth/login" className="text-sm text-[#94A3B8] hover:text-white transition-colors px-4 py-2">
              Log in
            </Link>
      ...
      <section className="pt-32 pb-24 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="#how-it-works" className="border border-[#334155] hover:border-teal-500 text-[#94A3B8] hover:text-white font-semibold px-8 py-4 rounded-xl text-lg transition-all">
              See How It Works
            </a>
          </div>
          <p className="text-sm text-[#475569] mt-6">5 free lessons per month · No credit card required</p>
        </div>
        ...
        <div className="max-w-5xl mx-auto mt-16 relative">
          <div className="bg-[#1E293B] rounded-2xl border border-[#334155] p-6 shadow-2xl">
            <div className="flex items-center gap-2 mb-4">
              ...
              <div className="flex-1 bg-[#0F172A] rounded-md h-6 ml-2" />
            </div>
              ...
              {['Warmer Activity', 'Main Activity', 'Language Focus'].map((title, i) => (
                <div key={i} className="bg-[#0F172A] rounded-xl p-4 border border-[#334155]">
                  ...
                  <div className="space-y-2">
                    <div className="h-2.5 bg-[#334155] rounded-full w-full" />
                    <div className="h-2.5 bg-[#334155] rounded-full w-4/5" />
                    <div className="h-2.5 bg-[#334155] rounded-full w-3/5" />
                  </div>
                </div>
              ))}
            </div>
      ...
      <section className="py-24 px-6 bg-[#0D1526]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-[#94A3B8] text-lg">Every ESL teacher knows these Sunday night feelings.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="bg-[#1E293B] border border-[#334155] rounded-xl p-6 hover:border-teal-600/50 transition-colors">
                <div className="w-10 h-10 bg-red-500/10 rounded-xl flex items-center justify-center mb-4">
                  <item.icon className="w-5 h-5 text-red-400" />
                </div>
                <h3 className="font-semibold text-[#F8FAFC] mb-2 leading-snug">&ldquo;{item.title}&rdquo;</h3>
      ...
      <section id="how-it-works" className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-[#94A3B8] text-lg">From idea to complete lesson in under 60 seconds.</p>
          </div>
      ...
      <section id="features" className="py-24 px-6 bg-[#0D1526]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-[#94A3B8] text-lg">Six powerful tools, one subscription.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="bg-[#1E293B] border border-[#334155] rounded-xl p-6 hover:border-teal-600/50 transition-all hover:-translate-y-1 duration-200 relative">
                {feature.tag && (
                ...
                <h3 className="font-semibold text-[#F8FAFC] mb-2">{feature.title}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="bg-[#1E293B] border border-[#334155] rounded-xl p-6">
                ...
                <p className="text-[#CBD5E1] leading-relaxed mb-4 italic">&ldquo;{t.text}&rdquo;</p>
                <div>
      ...
      <section className="py-24 px-6 bg-[#0D1526]" id="pricing">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-[#94A3B8] text-lg">Start free. Upgrade when you&apos;re ready.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-[#1E293B] border border-[#334155] rounded-2xl p-8">
              <div className="mb-6">
                ...
                <div className="text-[#94A3B8] text-sm mt-1">Forever free</div>
              </div>
              <ul className="space-y-3 mb-8">
                ...
                {['PDF export', 'Save to library'].map(f => (
                  <li key={f} className="flex items-center gap-3 text-sm text-[#475569] line-through">
                    <div className="w-4 h-4 rounded-full border border-[#334155] flex-shrink-0" />
                    {f}
                  </li>
                ))}
              </ul>
              <Link href="/auth/signup" className="block w-full text-center border border-[#334155] hover:border-teal-500 text-[#94A3B8] hover:text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                Get Started Free
              </Link>
            </div>
            <div className="bg-gradient-to-b from-teal-600/20 to-[#1E293B] border border-teal-600/50 rounded-2xl p-8 relative">
              ...
              <div className="mb-6">
                ...
                <div className="text-4xl font-extrabold text-teal-400">$19<span className="text-xl text-[#94A3B8] font-normal">/month</span></div>
                <div className="text-[#94A3B8] text-sm mt-1">Cancel anytime</div>
              </div>
              <ul className="space-y-3 mb-8">
      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-[#94A3B8] mb-10">Join thousands of TEFL teachers who plan smarter with PlanForge.</p>
      ...
      {/* Footer */}
      <footer className="border-t border-[#334155] py-12 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="text-sm text-[#475569]">© {new Date().getFullYear()} PlanForge. Built for teachers.</p>
        </div>
      </footer>
    </div>
  )
